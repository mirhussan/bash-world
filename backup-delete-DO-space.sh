...
for i in `seq -w 1 31`
do
s3cmd del s3://$SPACENAME/nginx/$i$DATE"_000001"/$NGINXFILENAME
s3cmd del s3://$SPACENAME/nginx/$i$DATE"_120001"/$NGINXFILENAME
#
s3cmd del s3://$SPACENAME/code/$i$DATE"_000001"/$CODEFILENAME
s3cmd del s3://$SPACENAME/code/$i$DATE"_120001"/$CODEFILENAME
#
